...
namespace Dotmim.Sync.PostgreSql.Builders
{
    ...
    public class NpgsqlDbMetadata : DbMetadata
    {
        ...
        /// </summary>
        public static bool IsGeometricType(SyncColumn column)
        {
            return column.OriginalTypeName?.ToLowerInvariant() is
                "geometry" or "geography" or
                "box" or "circle" or "line" or "lseg" or "path" or "polygon" or "point";
        }
