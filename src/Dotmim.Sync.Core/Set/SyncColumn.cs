...
namespace Dotmim.Sync
{
    ...
    public class SyncColumn : SyncNamedItem<SyncColumn>
    {
        ...
        public object GetDefaultValue()
        {
            ...
            // Return default values for known types without using Activator.CreateInstance (AOT-safe).
        ...
        internal static Type GetTypeFromAssemblyQualifiedName(string valueType)
        {
            ...
            throw new NotSupportedException($"The type code '{valueType}' is not a recognized Dotmim.Sync type identifier. " +
                "Runtime type loading via Type.GetType is not supported in AOT environments.");
        }
    }
}
